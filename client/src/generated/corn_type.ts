...
export namespace Corn {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: Corn): void {
    Corn.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): Corn {
    return Corn.getTypeScriptAlgebraicType().deserialize(reader);
  }
