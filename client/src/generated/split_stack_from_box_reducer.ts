 ...
 */
export namespace SplitStackFromBox {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: SplitStackFromBox): void {
    SplitStackFromBox.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): SplitStackFromBox {
    return SplitStackFromBox.getTypeScriptAlgebraicType().deserialize(reader);
  }
