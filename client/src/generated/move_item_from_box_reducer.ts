 ...
 */
export namespace MoveItemFromBox {
  /**
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: MoveItemFromBox): void {
    MoveItemFromBox.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): MoveItemFromBox {
    return MoveItemFromBox.getTypeScriptAlgebraicType().deserialize(reader);
  }
