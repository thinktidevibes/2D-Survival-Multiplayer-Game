...
export namespace Pumpkin {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: Pumpkin): void {
    Pumpkin.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): Pumpkin {
    return Pumpkin.getTypeScriptAlgebraicType().deserialize(reader);
  }
