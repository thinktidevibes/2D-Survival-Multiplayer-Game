...
export namespace Hemp {
  ...
  */
  ...
  export function serialize(writer: BinaryWriter, value: Hemp): void {
    Hemp.getTypeScriptAlgebraicType().serialize(writer, value);
  }

  export function deserialize(reader: BinaryReader): Hemp {
    return Hemp.getTypeScriptAlgebraicType().deserialize(reader);
  }
